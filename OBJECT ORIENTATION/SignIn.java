	...
	public SignIn(controller contr) {
		...
		btnLogin.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				StudenteDAO stu= new StudenteDAO();
				InsegnanteDAO ins= new InsegnanteDAO();
				String pas1=new String(stu.contrLog(textFieldLogin.getText(), "no"));
				String pas2=new String(ins.contrLog(textFieldLogin.getText(), "no"));
				if(pas1.equals(pas)) {
