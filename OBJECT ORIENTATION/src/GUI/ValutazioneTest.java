...
public class ValutazioneTest extends JFrame {
	...
	public ValutazioneTest (Controller c, String codTest, String login) {
		...
		btnEdit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				//model.setValueAt(textFieldVoto.getText(), i, 4);
			}
		});
	...
	//	table.getValueAt(ERROR, ABORT).toString()
		/*
		 * ciclo while colonna<5 prende ogni valore di ogni riga, lo mette nelle variabili e fa l'update (funzione la abbiamo già, dobbiamo eseguirla dandogli i valori come parametri
		 * 
		 **/
